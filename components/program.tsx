...
export function EventProgram() {
  const data = [
    {
      ...
      content: (
        <div className=" p-6 mb-4 rounded-lg transform transition-transform duration-300 hover:scale-105">
  ...
  return (
    <div className="content-visibility-auto bg-gradient-to-br from-[#002b56] via-[#003f7f] to-[#005e9b] py-10 px-6 ">
      <Timeline data={data} />
    </div>
  );
}
